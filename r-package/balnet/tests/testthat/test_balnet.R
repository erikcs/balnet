...
test_that("balnet has not changed", {
  ...
  expect_equal(
    ...
    list(control = list(intercepts = c(0.652873281422005, 0.66802481765921,
  0.680645954386779, 0.685941154728131, 0.687747421060082), betas = new("dgRMatrix",
      p = c(0L, 0L, 3L, 6L, 9L, 12L), j = c(0L, 1L, 2L, 0L, 1L,
      2L, 0L, 1L, 2L, 0L, 1L, 2L), Dim = c(5L, 3L), Dimnames = list(
          NULL, NULL), x = c(0.0507573767431381, 0.158769917286064,
      0.103686341052803, 0.0964925117386255, 0.210324237163201,
      0.145107291953369, 0.111004789201444, 0.227049604256553,
      0.157882123136175, 0.115601582272039, 0.232383701326134,
      0.161889105216467), factors = list())), treated = list(intercepts = c(-0.652873281422005,
  -0.682941839800975, -0.682398475582524, -0.681102012267433, -0.680577640484851
  ), betas = new("dgRMatrix", p = c(0L, 0L, 3L, 6L, 9L, 12L), j = c(0L,
  1L, 2L, 0L, 1L, 2L, 0L, 1L, 2L, 0L, 1L, 2L), Dim = c(5L, 3L),
      Dimnames = list(NULL, NULL), x = c(-0.00207812408065897,
      -0.118494422306579, -0.156693688472859, -0.0379564149766521,
      -0.142215753917237, -0.218193176446944, -0.0496225138747977,
      -0.149449789859248, -0.237897822417655, -0.0533492030403526,
      -0.151711346250273, -0.244157630108172), factors = list())))
  )

  expect_equal(
    coef(fit.att, lambda = fit.att[["_lambda"]]),
    list(intercepts = c(0.652873281422005, 0.667336389848779, 0.680472124137364,
0.68588965859546, 0.687731452647602), betas = new("dgRMatrix",
    p = c(0L, 0L, 3L, 6L, 9L, 12L), j = c(0L, 1L, 2L, 0L, 1L,
    2L, 0L, 1L, 2L, 0L, 1L, 2L), Dim = c(5L, 3L), Dimnames = list(
        NULL, NULL), x = c(0.0527093774420999, 0.152995377993314,
    0.112631732214514, 0.0970443032964536, 0.208453179362447,
    0.147901280091804, 0.111172722042331, 0.226453080921526,
    0.158762034363933, 0.115654028489226, 0.232194567332454,
    0.162166992288202), factors = list()))
  )

  expect_equal(
    coef(fit.att, lambda = c(-100, fit.att$lambda * 0.942, 0, 42)),
    list(intercepts = c(0.687731452647602, 0.654100093870745, 0.668450609688183,
    0.680931658735221, 0.686045886136906, 0.687731452647602, 0.687731452647602,
    0.652873281422005), betas = new("dgRMatrix", p = c(0L, 3L, 6L,
    9L, 12L, 15L, 18L, 21L, 21L), j = c(0L, 1L, 2L, 0L, 1L, 2L, 0L,
    1L, 2L, 0L, 1L, 2L, 0L, 1L, 2L, 0L, 1L, 2L, 0L, 1L, 2L), Dim = c(8L,
    3L), Dimnames = list(NULL, NULL), x = c(0.115654028489226, 0.232194567332454,
    0.162166992288202, 0.00447099741654189, 0.0129776137178316, 0.00955382529996484,
    0.0564700240021002, 0.157699506531369, 0.115623421076997, 0.0982427261725734,
    0.209979995220917, 0.148822528011033, 0.111552842440619, 0.226940094279606,
    0.159050855041043, 0.115654028489226, 0.232194567332454, 0.162166992288202,
    0.115654028489226, 0.232194567332454, 0.162166992288202), factors = list()))
  )
})
